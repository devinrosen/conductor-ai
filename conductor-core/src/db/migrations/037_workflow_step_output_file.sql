-- Migration 037: add 'script' to the workflow_run_steps role CHECK constraint
-- and add output_file column for persisting script step stdout file paths.
-- SQLite requires a table swap to modify CHECK constraints.
BEGIN;
...
INSERT INTO workflow_run_steps_new SELECT
    ...
    gate_approved_at, gate_feedback, structured_output, NULL
