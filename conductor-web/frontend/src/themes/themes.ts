/**
 * Conductor heritage railway themes.
 *
 * Each theme overrides Tailwind v4's --color-* CSS custom properties.
 * The "conductor-classic" theme matches the @theme defaults in index.css
 * so applying it is a no-op (or a reset to defaults).
 */

export interface ThemePalette {
  /** Tailwind gray scale (backgrounds, text, borders) */
  gray50: string;
  gray100: string;
  gray200: string;
  gray300: string;
  ...
  /** Primary accent (links, active nav, buttons) */
  accent: string;
  /** Active nav text / highlight */
  accentGlow: string;
